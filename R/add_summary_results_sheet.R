...
#'
#' @details
#' The summary results worksheet is used to summarize a prioritization.
#'
#' @inherit add_site_results_sheet return
#'
#' @noRd
add_summary_results_sheet <- function(x, data, comments = NULL, parameters) {
  # validate arguments
  ...
  # define parameters
  p <- parameters$summary_results_sheet
  start_row <- 3
  n_message_rows <- 2
