...
test_that("expected result", {
  ...
  dat <- template_status_data(sn, an, parameters)
  com <- template_status_comments(sd, ad, parameters)
  # main code
  w <- add_status_data_sheet(w, dat, com, parameters = parameters)
  # tests
